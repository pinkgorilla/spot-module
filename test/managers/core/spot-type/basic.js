...
var SpotType = require("../../../data/core/spot-type-data-util");
var SpotTypeManager = require("../../../../src/managers/core/spot-type-manager");
var instanceManager = null;
var validate = require("spot-models").validator.core.spotType;
...
before("#00. connect db", function(done) {
    helper.getDb()
        .then((db) => {
            instanceManager = new SpotTypeManager(db, {
                username: "unit-test"
            });
            done();
        })
...
it("#01. should error when create new spot-type with empty data", function(done) {
